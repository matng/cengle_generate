...
public class PowerServiceTest {
	...
	public void testList(){
		try {
			...
			powerVo.setiDisplayLength(powerService.selectPowerCount(powerVo));
			List<Power> powerList = powerService.selectPowerByPage(powerVo);
			System.out.println("返回总条数："+powerList.size());
			for(Power e : powerList){
	...
	public void testDel(){
		try {
			powerService.deletePowerByPrimaryKey((Integer)id);
