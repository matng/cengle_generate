...
public class RoleCtl extends BaseCtl{
	...
	private final static Logger log= Logger.getLogger(RoleCtl.class);
	...
	public String getRoleList (HttpServletRequest req,RoleVo vo) throws Exception{
	    	String json = null;
		try {
			List<Role> list = roleService.selectRoleByPage(vo);
			int totalCount = roleService.selectRoleCount(vo);
	...
	public String delete(@RequestBody String json) {  
		...
		try {
			...
			{
				i = roleService.deleteRoleByBatch(role.getIdList());
			}
	...
	public String edit(@RequestBody String json) {
		...
		try {
			log.debug("===json="+json);	
			Role role = JSON.parseObject(json,Role.class);
			int i = roleService.updateRoleByPrimaryKeySelective(role);
